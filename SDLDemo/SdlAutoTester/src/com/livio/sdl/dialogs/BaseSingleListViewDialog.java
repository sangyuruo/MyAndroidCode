 ...
 * to select a single listview item. The selected item is returned to the
 * listener as a generic object.
 *
 * @author Mike Burke
 *
 * @param <E>
...
public abstract class BaseSingleListViewDialog<E> extends BaseAlertDialog {
	...
	// since this class is abstract, we'll keep these variables protected so
	...
	public BaseSingleListViewDialog(Context context, String title, List<E> items) {
		...
		adapter = new ArrayAdapter<E>(context,
	...
	protected void findViews(View parent) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				selectedItem = ((ArrayAdapter<E>) parent.getAdapter())
						.getItem(position);
