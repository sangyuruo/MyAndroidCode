...
/**
 * A simple dialog that contains a single, scrollable TextView. The textview is
 * initialized with a the title and message in the constructor.
 *
 * @author Mike Burke
 *
 */
public class TextViewOkCancelDialog extends BaseOkCancelDialog {
	...
	public TextViewOkCancelDialog(Context context, String dialogTitle,
			String message) {
