...
/**
 * An abstract class that represents a dialog with an OK button and a cancel
 * button. Subclasses can extend this class to create different types of
 * OK/Cancel dialogs. Subclasses must set positive / negative buttons in their
 * constructor and call createDialog() as the last line of the constructor.
 *
 * @author Mike Burke
 *
 */
public abstract class BaseOkCancelDialog extends BaseAlertDialog {
		...
		builder.setTitle(title)
				...
				.setPositiveButton(
						context.getResources().getString(
								R.string.positive_button), okButton)
				.setNegativeButton(
						context.getResources().getString(
								R.string.negative_button), cancelButton)
	 ...
	 * 
	 * @param okButton
	 *            The button click listener for the positive button
	 */
	protected void setPositiveButton(DialogInterface.OnClickListener okButton) {
		this.okButton = okButton;
		if (dialog != null) {
			dialog.setButton(DialogInterface.BUTTON_POSITIVE, context
	 ...
	 * 
	 * @param cancelButton
	 *            The button click listener for the negative button
	 */
	protected void setNegativeButton(
			DialogInterface.OnClickListener cancelButton) {
		this.cancelButton = cancelButton;
		if (dialog != null) {
			dialog.setButton(DialogInterface.BUTTON_NEGATIVE, context
