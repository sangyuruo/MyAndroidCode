 ...
 * multiple listview items. Selected items are stored in a protected List<E>
 * object called selectedItems, which can be used by subclasses of this class.
 *
 * @author Mike Burke
 *
 * @param <E>
...
public class MultipleListViewDialog<E> extends BaseMultipleListViewDialog<E> {
	...
	public MultipleListViewDialog(Context context, String title, List<E> items,
		...
		if (selectedItems != null && selectedItems.size() > 0) {
			// TODO: make this more efficient, but should be good enough for
			// small data sets
